// megafunction wizard: %altmemphy v18.0%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			sdramController_phy_alt_mem_phy
// ============================================================
// Generated by altmemphy 18.0 [Altera, IP Toolbench 1.3.0 Build 614]
// ************************************************************
...
module sdramController_phy (
	...
	sdramController_phy_alt_mem_phy	sdramController_phy_alt_mem_phy_inst(
	...
	defparam
		sdramController_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		sdramController_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		sdramController_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		sdramController_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		sdramController_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		sdramController_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		sdramController_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		sdramController_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		sdramController_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6024,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6024 ps",
		sdramController_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 98,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		sdramController_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 48,
		sdramController_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		sdramController_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		sdramController_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		sdramController_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		sdramController_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="18.0"  build="198"  iptb_version="1.3.0 Build 614"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="sdramController_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "local_if_clk_mhz_label" value="166.0"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "pll_ref_clk_ps_label" value="(20833 ps)"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "pll_ref_clk_mhz" value="48.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_clk_ps_label" value="(6024 ps)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="JEDEC DDR-400 256Mb x8"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tdqsck_ps" value="600"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tfaw_ns" value="0.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_trtp_ns" value="0.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tcl" value="2.5"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="sdramController_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="sdramController_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+sdramController_phy_alt_mem_phy_seq_wrapper;+sdramController_phy_alt_mem_phy_reconfig;+sdramController_phy_alt_mem_phy_pll;+sdramController_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\sparkboxHD\gpu\pipe_3_layerRam\de0nano/sdramController_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="sdramController_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
