...
module sdramInterface (
	...
	wire [1:0] signal_wire26 = 2'b0;
	wire signal_wire27 = 1'b0;
	wire [1:0] signal_wire28 = 2'b0;

	sdramInterface_controller_phy	sdramInterface_controller_phy_inst(
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRControllerMVCModel"  active_core="sdramInterface_controller_phy" >
...
// Retrieval info:      <PRIVATE name = "alt_top" value="sdramInterface_alt_mem_ddrx_controller_top"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "nativelink_excludes" value="sdramInterface_phy_alt_mem_phy_seq.vhd,sdramInterface_phy_alt_mem_phy_seq_wrapper.vhd,sdramInterface_phy_alt_mem_phy_seq_wrapper.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "native" value="verilog"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="sdramInterface_alt_mem_ddrx_controller_top.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+sdramInterface_alt_mem_phy_seq_wrapper;+sdramInterface_alt_mem_phy_reconfig;+sdramInterface_alt_mem_phy_pll;+sdramInterface_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\sparkboxHD\gpu\sdram/sdramInterface_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="sdramInterface_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
