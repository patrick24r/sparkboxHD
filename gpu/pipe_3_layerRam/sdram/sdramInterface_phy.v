...
// ============================================================
// Megafunction Name(s):
// 			sdramInterface_phy_alt_mem_phy
// ============================================================
...
module sdramInterface_phy (
	...
	sdramInterface_phy_alt_mem_phy	sdramInterface_phy_alt_mem_phy_inst(
	...
	defparam
		sdramInterface_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR",
		sdramInterface_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		sdramInterface_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		sdramInterface_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		sdramInterface_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		sdramInterface_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		sdramInterface_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		sdramInterface_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 14,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 2,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 2,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 2,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 6000,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "6000 ps",
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 98,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		sdramInterface_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 56,
		sdramInterface_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		sdramInterface_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		sdramInterface_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		sdramInterface_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="sdramInterface_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "mem_if_clk_mhz" value="166.667"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_clk_ps_label" value="(6000 ps)"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_fmax" value="166.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Custom (JEDEC DDR-400 1Gb x16)"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "fast_simulation_en" value="FAST"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "mem_if_cs_width" value="2"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="sdramInterface_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="sdramInterface_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+sdramInterface_phy_alt_mem_phy_seq_wrapper;+sdramInterface_phy_alt_mem_phy_reconfig;+sdramInterface_phy_alt_mem_phy_pll;+sdramInterface_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\sparkboxHD\gpu\sdram/sdramInterface_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="sdramInterface_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// IPFS_FILES: sdramInterface_phy_alt_mem_phy_seq_wrapper.vo;
// =========================================================
