...
void MX_MDMA_Init(void)
{
  ...
  if (HAL_MDMA_LinkedList_CreateNode(&node_mdma_channel40_sw_1, &nodeConfig) != HAL_OK)
  {
    Error_Handler();
  }
  /* USER CODE BEGIN mdma_channel40_sw_1 */

  /* USER CODE END mdma_channel40_sw_1 */

  /* Connect a node to the linked list */
  if (HAL_MDMA_LinkedList_AddNode(&hmdma_mdma_channel40_sw_0, &node_mdma_channel40_sw_1, 0) != HAL_OK)
  {
    Error_Handler();
  }
